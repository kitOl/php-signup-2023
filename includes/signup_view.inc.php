...
function signup_inputs()
{
    if (
        ...
        echo '<input type="text" name="username" placeholder="Username" autocomplete="off" value="' . $_SESSION['signup_data']['username'] . '">';
    } else {
    ...
    if (
        ...
        echo '<input type="text" name="email" placeholder="E-mail" autocomplete="off" value="' . $_SESSION['signup_data']['email'] . '">';
    } else {
...
function check_signup_errors()
{
    if (isset($_SESSION['errors_signup'])) {
        ...
        foreach ($errors as $error) {
            echo '<p class="form form-error">' . $error . '</p>';
        }

        unset($_SESSION['errors_signup']);
    } else if (isset($_GET['signup']) && $_GET['signup'] === 'success') {
        echo '<br>';
        echo '<p class="form form-success">Signup success!</p>';
    }
}
